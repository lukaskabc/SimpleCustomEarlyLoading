...
public record FrameControl(int width, int height, int xOffset, int yOffset, float delay) {
    public FrameControl(PngFrameControl pngFrameControl) {
        this(pngFrameControl.width,
                ...
                pngFrameControl.delayNumerator /
                        (float) pngFrameControl.delayDenominator);
    }
}
